...
QT_MOC_LITERAL(1, 13, 15), // "DeleteTriggered"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 13), // "ValidateInput"
QT_MOC_LITERAL(4, 44, 6) // "accept"

    },
    "RegistDialog\0DeleteTriggered\0\0"
    "ValidateInput\0accept"
};
...
void RegistDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DeleteTriggered(); break;
        ...
        {
            using _t = void (RegistDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegistDialog::DeleteTriggered)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegistDialog::DeleteTriggered()
{
